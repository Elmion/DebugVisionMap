...
namespace TriangleNet.Rendering.GDI
{
    ...
    {
        public event Action<Vertex> OnRenderLeftClick;
        public event Action<Vertex> OnRenderRightClick;
        ...
        protected override void OnMouseClick(MouseEventArgs e)
        {
            ...
            else if (e.Button == MouseButtons.Left)
            {
                ...
                OnRenderLeftClick?.Invoke(new Vertex(c.X, c.Y));
            ...
            } else if(e.Button == MouseButtons.Right)
            {
                ...
                OnRenderRightClick?.Invoke(new Vertex(c.X, c.Y));
